...
async def help(client, message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("Join Group Amoi", url="https://t.me/freetipsgame"),
                    InlineKeyboardButton("About Me", callback_data="about_data")
                ],
                [
                    InlineKeyboardButton("BOT Channel", url="https://t.me/ScannerRose88"),
                    InlineKeyboardButton("Support Group", url="https://t.me/freetipsgame")
                ]
            ]
        ),
        reply_to_message_id=message.message_id
